(() => {
    ...
    function theme() {
        ...
        if (wrapper.style.backgroundColor = "rgb(31, 46, 53)") wrapper.style.backgroundColor = "black"; else if (wrapper.style.backgroundColor = "black") wrapper.style.backgroundColor = "rgb(31, 46, 53)";
    }
    window["FLS"] = true;
    isWebp();
    menuInit();
